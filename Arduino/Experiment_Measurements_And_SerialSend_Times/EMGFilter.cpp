...
// coefficients of transfer function of anti-hum filter (Fixed comma bug!)
...
static float ahf_denominator_coef_50Hz[2][6] = {
    {1.0000, -1.5395, 0.9056, 1.0000, -1.1187, 0.3129}, // <-- Comma fixed here
